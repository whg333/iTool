...
public class ObjectCodec {
     ...
     * List<byte[]> output of {@link com.hoolai.keyvalue.jredis.JRedis#keys()}
     * 
     * @param bytearray
     * @return
     */
     ...
     * list returned from a {@link com.hoolai.keyvalue.jredis.JRedis} method such as
     * {@link com.hoolai.keyvalue.jredis.JRedis#smembers(String)}, and that this list contains the
