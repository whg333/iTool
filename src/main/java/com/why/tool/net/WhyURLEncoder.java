 ...
 * @version %I%, %G%
 * @since   JDK1.0
 * @changed by luzj 增加对"*"号的转编码, 默认encode字符信为"utf-8"
 */
public class WhyURLEncoder {
...
//   );
     ...
     * @attention the default encoding is utf-8
