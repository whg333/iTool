...
public final class RSAUtils {
	...
	/* 密钥内容 base64 code */
	public static String PUCLIC_KEY = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCfRTdcPIH10gT9f31rQuIInLwe" + "\r"
			+ "7fl2dtEJ93gTmjE9c2H+kLVENWgECiJVQ5sonQNfwToMKdO0b3Olf4pgBKeLThra" + "\r"
			+ "z/L3nYJYlbqjHC3jTjUnZc0luumpXGsox62+PuSGBlfb8zJO6hix4GV/vhyQVCpG" + "\r" + "9aYqgE7zyTRZYX9byQIDAQAB" + "\r";
	
	public static String PRIVATE_KEY = "MIICdwIBADANBgkqhkiG9w0BAQEFAASCAmEwggJdAgEAAoGBAJ9FN1w8gfXSBP1/" + "\r"
	...
	public static String encrypt(String plainText) {
		return encrypt(plainText, PUCLIC_KEY);
	}
	...
	public static String encrypt(String plainText, Key publicKey) {
		byte[] encryptByte = encryptData(plainText.getBytes(), publicKey);
	...
	public static String decrypt(String cipherText, Key privateKey) {
		String encryptContent = cipherText;
	 ...
	 * @return
	 */
	public static byte[] decryptData(byte[] encryptedData, Key privateKey) {
		try {
			Cipher cipher = Cipher.getInstance(RSA);
